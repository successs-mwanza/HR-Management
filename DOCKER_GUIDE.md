...
```
- Access backend at `localhost:8081`
...
- Check backend uses `postgres:5432` not `localhost:5433`
- Wait 10-15 seconds for postgres health check

### Frontend shows blank page
- Check logs: `docker-compose logs frontend`
- Ensure `REACT_APP_API_URL=http://localhost:8081/api`
...
3. **Test the flow**:
   ...
   - Check backend at http://localhost:8081/api/employees
